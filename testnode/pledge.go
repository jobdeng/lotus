...
//func TestSDRUpgrade(t *testing.T, b test.APIBuilder, blocktime time.Duration) {
//	ctx, cancel := context.WithCancel(context.Background())
//	defer cancel()
//
//	n, sn := b(t, []test.FullNodeOpts{test.FullNodeWithSDRAt(500, 1000)}, test.OneMiner)
...
//}
//
//func TestPledgeBatching(t *testing.T, b test.APIBuilder, blocktime time.Duration, nSectors int) {
//	ctx, cancel := context.WithCancel(context.Background())
//	defer cancel()
//
//	n, sn := b(t, []test.FullNodeOpts{test.FullNodeWithLatestActorsAt(-1)}, test.OneMiner)
//	client := n[0].FullNode.(*impl.FullNodeAPI)
//	miner := sn[0]
//
//	addrinfo, err := client.NetAddrsListen(ctx)
...
//}
//
//func TestPledgeBeforeNv13(t *testing.T, b test.APIBuilder, blocktime time.Duration, nSectors int) {
//	ctx, cancel := context.WithCancel(context.Background())
//	defer cancel()
//
//	n, sn := b(t, []test.FullNodeOpts{
//		{
...
//}
//
//func TestPledgeSector(t *testing.T, b test.APIBuilder, blocktime time.Duration, nSectors int) {
//	ctx, cancel := context.WithCancel(context.Background())
//	defer cancel()
//
//	n, sn := b(t, test.OneFull, OneMiner)
//	client := n[0].FullNode.(*impl.FullNodeAPI)
//	miner := sn[0]
//
//	addrinfo, err := client.NetAddrsListen(ctx)
...
//}
//
//func flushSealingBatches(t *testing.T, ctx context.Context, miner test.TestStorageNode) {
//	pcb, err := miner.SectorPreCommitFlush(ctx)
//	require.NoError(t, err)
//	if pcb != nil {
//		fmt.Printf("PRECOMMIT BATCH: %+v\n", pcb)
...
//}
//
//func startPledge(t *testing.T, ctx context.Context, miner test.TestStorageNode, n, existing int, blockNotif <-chan struct{}) map[abi.SectorNumber]struct{} {
//	for i := 0; i < n; i++ {
...
//}
//
//func pledgeSectors(t *testing.T, ctx context.Context, miner test.TestStorageNode, n, existing int, blockNotif <-chan struct{}) {
...
//}
//
//var OneMiner = []test.StorageMiner{{
//	Full:    0,
